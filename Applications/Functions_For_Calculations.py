...
def plus(value): return lambda x: x + value
def minus(value): return lambda x: x - value
def multiply_by(value): return lambda x: x * value
def divide_by(value): return lambda x: x // value


print(seven(plus(six())))
print(eight(multiply_by(nine())))
print(nine(multiply_by(six())))
