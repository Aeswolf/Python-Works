...
between a given starting node and a terminal node for a directed graph
"""

# Depth first traversal Algorithm
from collections import \
    namedtuple  # importing namedtuple from collections in order to be able to provide a class template for Graph


# function to aid create an adjacency list for the given directed graph
...
print(has_path(create_adjacency_list(graph), 'j', 'k'))